  ...
  const SingleRestroom = () => {
    ...
    useEffect(() => {
      const savedRestroomIdsFromStorage = JSON.parse(
        sessionStorage.getItem("savedRestroomIds")
      ) || {};

      const isRestroomSaved = savedRestroomIdsFromStorage[storedUserId]?.includes(parseInt(id)) || false;
              ...
              <Container>
                ...
                >
                  ...
                  <Snackbar
                    ...
                    message={
                      <>
                        {restroom.name} is {!isSaved ? "no longer saved" : "saved"}{" "}
                        <BookmarkAddedRoundedIcon />
                      </>
                    }
